...
#        cv2.imwrite("T.jpg", crop_img)
    ...
    #change text to black and background to white. This is required for Pytesseract to read the text
#    crop_img = np.invert(crop_img)

#   You can save the image in your local folder to check whether the coordinate is correct. This is only for testing purpose.
#    cv2.imwrite("T.jpg", crop_img)

    #get text
#    text = pytesseract.image_to_string(crop_img, config='--psm 7 --dpi 300')
#    print(text)
